...
//輸入WIFI連線帳號密碼
const char* ssid = "Sony Xperia X Performance";
    ...
    if (align_face(net_boxes, image_matrix, aligned_face) == ESP_OK){
        if (is_enrolling == 1){  //註冊人臉
            ...
            if (matched_id >= 0) {  //若辨識為已註冊之人臉
                ...
                rgb_print(image_matrix, FACE_COLOR_RED, "Tidak Ada Kecocokan!");
                matched_id = -1;
        ...
        rgb_print(image_matrix, FACE_COLOR_YELLOW, "Wajah Terdeteksi");
    }
    Serial.println();
